globalThis.makoModuleHotUpdate('p__CommunityDiscovery__index', {
            ...
            const CommunityDiscoveryPage = ()=>{
                ...
                const loadFullGraph = (0, _react.useCallback)(async (data, layer)=>{
                    ...
                    try {
                        ...
                        const results = await Promise.all(topCommunities.map((c)=>(0, _service.getCommunityGraph)(c.community_id, layer, 100).catch(()=>null)));
                        const allNodes = [];
                        const allEdges = [];
    ...
    runtime._h = '8764851776540721840';
...
//# sourceMappingURL=p__CommunityDiscovery__index-async.6560269150768266039.hot-update.js.map