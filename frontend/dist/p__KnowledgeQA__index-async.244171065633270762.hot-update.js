globalThis.makoModuleHotUpdate('p__KnowledgeQA__index', {
    modules: {
        "src/pages/KnowledgeQA/components/ComplianceAnalysisPanel.tsx": function(module, exports, __mako_require__) {
            ...
            const ComplianceAnalysisPanel = ({ report, currentSubgraph, isLoading, onJumpToGraph, complianceIndicators })=>{
                ...
                (0, _react.useCallback)((indicatorId, rawValue)=>{
                ...
                const treeColumns = (0, _react.useMemo)(()=>[
                        ...
                        },
                        {
                            ...
                            render: (_, record)=>{
                                ...
                                return /*#__PURE__*/ (0, _jsxdevruntime.jsxDEV)(_antd.InputNumber, {
                                    size: "small",
                                    min: -10,
                                    max: 10,
                                    step: 1,
                                    value: record.subjective ?? 0,
                                    onChange: (val)=>{
                                        setSubjectiveMap((prev)=>({
                                                ...prev,
                                                [record.indicatorId]: typeof val === 'number' ? val : 0
                                            }));
                                    },
                                    style: {
                                        width: 72
            ...
            _s(ComplianceAnalysisPanel, "SPR8PosU8xYQS0Y1ZkdL1umyoOI=");
    ...
    runtime._h = '18304415317366624597';
...
//# sourceMappingURL=p__KnowledgeQA__index-async.244171065633270762.hot-update.js.map